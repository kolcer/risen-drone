...
WISDOM = [
    ...
    "The only way to do great work is to love what you do. Keep searching, you'll find your favorite job soon!",
    ...
    "It's important to take care of yourself, both physically and mentally. Make sure you're getting enough rest and self-care. And food. And water. And exercise. And touch grass. Stay hydrated!",
    "The journey of a thousand miles begins with a single step. Keep moving forward, one step at a time. Eventually you will either collapse or get to your destination.",
    "Sometimes, the best course of action is to admit that you don't know the answer and seek help from someone who does. STACK OVERFLOW MY GOD!!!",
    ...
    "The key to success is to always follow your dreams, unless your dreams involve eating an entire box of ores by yourself every night. In that case, it's probably best to reevaluate your goals.",
    "If at first you don't succeed, destroy all evidence that you tried. It's the wisest thing to do.",
    "The best way to deal with problems is to ignore them and hope they go away on their own. Trust me, it always works.",
    "If you want to be successful in life, just remember to always take the path of least resistance. Why make things harder than they have to be? And do not take that step to start going 1000 miles, you will die.",
    "The secret to happiness is to lower your expectations so much that you can't be disappointed. It's foolproof!",
    "Always remember that the first bird gets the dirt, but the second mouse gets the cheese. Remember, first is the worst, second the best.",
    "Life is like a box of mega creme oreos. You never know what you're gonna get, but you're probably gonna regret eating them all anyway.",
    ...
    "If you're feeling lost, try asking for directions. Unless you're in the middle of a forest with no cell phone reception, in which case, good luck.",
    "You keep getting challenges thrown at? Embrace them. And if you can't embrace them, at least give them a polite nod and a smile before walking away.",
    "In trying times, taking a deep breath and counting to ten could help alleviate the stress. And if that doesn't work, try taking a deep breath and counting to twenty. And if that still doesn't work, maybe it's time for a vacation.",
