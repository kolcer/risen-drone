...
OBJECTS = {
    ...
    "a refridgerator": {"Try to catch it", "See what's inside", "Stand still", "Dive"},
    "a Mana orb": {"Stand still", "Look at its color", "Avoid it", "Ask about its origin"},
...
I_SPY = {
    ...
    'questions': [ 
        ...
        "I spy with my little eye something beginning with the letter **N**.",
    ],
    'answers':[
        "stairs",
        "more stairs",
        "even more stairs",
        "a lot more of stairs",
