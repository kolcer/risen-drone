...
WISDOM = [
    ...
    # (Kind of) Serious Wisdom Responses - NOT ANYMORE, IDIOT
    ...
    "If you're feeling lost and unsure about life, just remember that you're not alone. Most of us have no idea what we're doing either. And also go north until you fall of a cliff, then turn south and go all the way back to where you started!",
